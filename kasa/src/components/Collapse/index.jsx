...
const arrowUp =<svg xmlns="http://www.w3.org/2000/svg" width="24" height="14" viewBox="0 0 24 14" fill="none">
...
function Collapse({ title, children }) {
    ...
    return (
      <div className={styles.collapse} onClick={toggleCollapse}>
        ...
        <div className={`${isCollapsed ? styles.collapseContent : styles.collapseContentHidden}`}>{children}</div>
      </div>
    );
  }
